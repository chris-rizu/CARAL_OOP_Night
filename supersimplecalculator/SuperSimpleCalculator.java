package supersimplecalculator;
import java.awt.*;
import javax.swing.*;

public class SuperSimpleCalculator extends javax.swing.JFrame {

    double num1, num2, result;
    String op;
    public SuperSimpleCalculator() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jbtnDel.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        jbtnDel.setText("DEL");
        ...
        jbtnC.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        jbtnC.setText("C");
        ...
        jbtnDigit9.setBackground(new java.awt.Color(255, 255, 0));
        ...
        jbtnDigit8.setBackground(new java.awt.Color(255, 153, 51));
        ...
        jbtnDigit7.setBackground(new java.awt.Color(255, 51, 51));
        ...
        jbtnDigit4.setBackground(new java.awt.Color(0, 255, 51));
        ...
        jbtnDigit1.setBackground(new java.awt.Color(204, 0, 204));
        ...
        jbtnDigit2.setBackground(new java.awt.Color(255, 51, 255));
        ...
        jbtnDigit5.setBackground(new java.awt.Color(0, 153, 255));
        ...
        jbtnDigit6.setBackground(new java.awt.Color(0, 0, 255));
        ...
        jbtnDigit3.setBackground(new java.awt.Color(255, 204, 255));
        ...
        jTextField2.setText("Simple Calculator");
...
int num = Integer.parseInt(jtxtResult.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuperSimpleCalculator().setVisible(true);
            }
        });
    }
